...
def _test():
    ...
    print(
        f"difference between actual subtraction and subtraction in compressed domain = {(subtraction - decompressed_subtraction[:28, :28]).norm(torch.inf)} "
    )
    print(
        f"difference between actual subtraction and subtraction after decompressing the data = {(subtraction - subtraction_compression_decompression[:28, :28]).norm(torch.inf)}"
    )
    time1 = end1 - begin1
