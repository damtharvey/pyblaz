...
a = torch.tensor(rho_1[:251001]).view(501, 501).type(dtype).to(device)
b = torch.tensor(rho_2[:251001]).view(501, 501).type(dtype).to(device)
...
print(
    f"difference between actual subtraction and subtraction in compressed domain = {(subtraction - decompressed_subtraction[:501, :501]).norm(torch.inf)} "
)
print(
    f"difference between actual subtraction and subtraction after decompressing the data = {(subtraction - subtraction_compression_decompression[:501, :501]).norm(torch.inf)}"
)
time1 = end1 - begin1
