...
rho_1 = []
with open("/home/tripti/Pyblaz/pyblaz/data/OrzagTang_singleprecision/1.csv") as csv_file:
    next(csv_file)
    for row in csv.reader(csv_file, delimiter=','):
        rho_1.append(float(row[0]))

rho_2 = []
with open("/home/tripti/Pyblaz/pyblaz/data/OrzagTang_singleprecision/2.csv") as csv_file:
    next(csv_file)
    for row in csv.reader(csv_file, delimiter=','):
