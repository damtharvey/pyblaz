...
class Compressor:
    ...
    def block_transform(
        self, slope_indices: torch.Tensor, n_coefficients: int = None, inverse: bool = False
    ) -> torch.Tensor:
        """
        Section II.d
        ...
        :return:
        """
        # TODO: Avoid redundant transformer_tensor creation.
    ...
    def const_mul_block(self, a: CompressedBlock, c: float) -> CompressedBlock:
        ...
        :param a: compressed block
        :param c: scalar
        :return: the compressed product of a and c
        """
        a_indices = a.indices.type(torch.int64)
    ...
    def hadamard_block(self, a: CompressedBlock, b: CompressedBlock) -> CompressedBlock:
        ...
        :param a: compressed block
        :param b: compressed block
        :return: the compressed product of a and b
        """
        a_indices = a.indices.type(torch.int64)
        b_indices = b.indices.type(torch.int64)
